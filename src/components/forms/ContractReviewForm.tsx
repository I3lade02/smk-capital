...
const contractReviewEndpoint =
  import.meta.env.VITE_CONTRACT_REVIEW_ENDPOINT ??
...
const contractReviewFormSchema = z
  .object({
    ...
    files: z
      ...
      .min(1, "Nahrajte prosím alespoň jednu smlouvu nebo fotografii.")
    ...
    >
      <div>
        ...
        <h2 className="mt-3 font-serif text-4xl leading-tight">
          Pošlete smlouvy k bezplatné kontrole.
        </h2>
        ...
        >
          ...
          <span className="mt-4 text-sm font-semibold">
            {selectedFiles.length > 0
              ...
              : "Nahrát smlouvy v PDF nebo jako fotografie"}
          </span>
