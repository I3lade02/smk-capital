  ...
  return (
    <section className="relative flex min-h-[76vh] items-center overflow-hidden bg-[var(--section-bg)] px-5 pb-20 pt-36 md:px-12 lg:px-16 lg:pt-40">
      ...
      <div className="relative z-10 grid w-full items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <SectionKicker>Chyba 404</SectionKicker>
          ...
          <p className="mt-7 max-w-xl text-lg leading-8 text-[#061a34]/65">
            Odkaz, který hledáte, ještě není aktivní nebo byl přesunut. Vraťte
            se na hlavní stránku, případně si prohlédněte naše služby.
          </p>
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            ...
            >
              <IconHome size={17} strokeWidth={1.8} aria-hidden="true" />
            ...
            >
              <IconArrowLeft size={17} strokeWidth={1.8} aria-hidden="true" />
              Prohlédnout služby
            </Link>
          </div>
        </div>
